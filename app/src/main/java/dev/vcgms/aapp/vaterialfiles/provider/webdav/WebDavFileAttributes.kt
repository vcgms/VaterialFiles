...
import dev.vcgms.aapp.vaterialfiles.provider.common.AbstractBasicFileAttributes
import dev.vcgms.aapp.vaterialfiles.provider.common.BasicFileType
...
import dev.vcgms.aapp.vaterialfiles.provider.webdav.client.creationTime
import dev.vcgms.aapp.vaterialfiles.provider.webdav.client.isDirectory
import dev.vcgms.aapp.vaterialfiles.provider.webdav.client.isSymbolicLink
import dev.vcgms.aapp.vaterialfiles.provider.webdav.client.lastModifiedTime
import dev.vcgms.aapp.vaterialfiles.provider.webdav.client.size
