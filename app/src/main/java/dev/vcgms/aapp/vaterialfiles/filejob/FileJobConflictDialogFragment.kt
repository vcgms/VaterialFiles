...
import dev.vcgms.aapp.vaterialfiles.databinding.FileJobConflictDialogViewBinding
...
import dev.vcgms.aapp.vaterialfiles.filelist.appDirectoryPackageName
import dev.vcgms.aapp.vaterialfiles.filelist.supportsThumbnail
...
import dev.vcgms.aapp.vaterialfiles.util.shortAnimTime
import dev.vcgms.aapp.vaterialfiles.util.showSoftInput
...
class FileJobConflictDialogFragment : AppCompatDialogFragment() {
    ...
    /** @see dev.vcgms.aapp.vaterialfiles.filelist.FileListAdapter.onBindViewHolder */
