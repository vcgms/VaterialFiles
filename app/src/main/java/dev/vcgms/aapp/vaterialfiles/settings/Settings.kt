...
import dev.vcgms.aapp.vaterialfiles.compat.EnvironmentCompat2
import dev.vcgms.aapp.vaterialfiles.filelist.FileSortOptions
import dev.vcgms.aapp.vaterialfiles.filelist.FileViewType
import dev.vcgms.aapp.vaterialfiles.filelist.GridColumnCount
import dev.vcgms.aapp.vaterialfiles.filelist.OpenApkDefaultAction
...
import dev.vcgms.aapp.vaterialfiles.storage.Storage
...
object Settings {
    ...
    val FILE_LIST_GRID_COLUMNS: SettingLiveData<GridColumnCount> =
        EnumSettingLiveData(
            ...
            R.string.pref_default_value_file_list_grid_columns,
            GridColumnCount::class.java
        )
    ...
    val DISPLAY_SIZE: SettingLiveData<DisplaySize> =
        EnumSettingLiveData(
            R.string.pref_key_display_size, R.string.pref_default_value_display_size,
            DisplaySize::class.java
        )
    ...
    val AUTH_MODE: SettingLiveData<AuthMode> =
        EnumSettingLiveData(
            R.string.pref_key_auth_mode, R.string.pref_default_value_auth_mode,
            AuthMode::class.java
        )
}
